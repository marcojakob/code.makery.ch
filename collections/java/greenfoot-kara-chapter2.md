...
- header: Downloads
  ...
  - text: scenarios-chapter-2.zip
    link: http://swisseduc.ch/informatik/karatojava/greenfootkara/classes/scenarios-chapter-2.zip
    icon-css: fa fa-fw fa-archive
  - text: chapter-2-program-flow.docx
    link: http://swisseduc.ch/informatik/karatojava/greenfootkara/docs/en/chapter-2-program-flow.docx
...
<table class="table table-bordered text-center">
  <tbody>
    <tr>
      <td><img src="/assets/java/greenfoot-kara-chapter2/flowchart-symbol1.png"></td>
      <td>Start / Stop</td>
    </tr>
    <tr>
      <td><img src="/assets/java/greenfoot-kara-chapter2/flowchart-symbol2.png"></td>
      <td>Activity</td>
    </tr>
    <tr>
      <td><img src="/assets/java/greenfoot-kara-chapter2/flowchart-symbol3.png"></td>
...
![Task 1 - World 1](/assets/java/greenfoot-kara-chapter2/task01-world1.png) 

![Task 1 - World 2](/assets/java/greenfoot-kara-chapter2/task01-world2.png)
...
![Task 1 - Flowchart](/assets/java/greenfoot-kara-chapter2/task01-flowchart.png) 
...
![Kara Methods](/assets/java/greenfoot-kara-chapter2/task02-kara-methods.png)
...
![Task 8](/assets/java/greenfoot-kara-chapter2/task08.png)
...
![Task 9](/assets/java/greenfoot-kara-chapter2/task09.png)
...
![Task 10](/assets/java/greenfoot-kara-chapter2/task10.png)
...
![Task 12](/assets/java/greenfoot-kara-chapter2/task12.png)
...
![Loop Example](/assets/java/greenfoot-kara-chapter2/loop-example-world.png)

In the flow chart you can see that `move()` is executed repeatedly, as long as no tree stands in front of Kara.

![Loop Example - Flowchart](/assets/java/greenfoot-kara-chapter2/loop-example-flowchart.png)
...
![Task 13](/assets/java/greenfoot-kara-chapter2/task13.png)
...
![Task 14](/assets/java/greenfoot-kara-chapter2/task14.png)
...
* Load the scenario **Kara 14 ...** and improve the method `goAroundTree()` so that Kara can walk around several trees. Test your program in all available worlds.
...
![Task 15](/assets/java/greenfoot-kara-chapter2/task15.png)
...
Continue with [Chapter 3: Variables](/java/greenfoot-kara-chapter3/)
