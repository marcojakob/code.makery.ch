...
![New FXML Document](/assets/java/javafx-8-tutorial-part1/new-fxml-document.png)

![New PersonOverview](/assets/java/javafx-8-tutorial-part1/new-person-overview.png)
...
![Anchor Pane Size](/assets/java/javafx-8-tutorial-part1/anchor-pane-size.png)
...
![Fit to Parent](/assets/java/javafx-8-tutorial-part1/fit-to-parent.png)
...
![TableView Anchors](/assets/java/javafx-8-tutorial-part1/table-view-anchors.png)
...
![Column Texts](/assets/java/javafx-8-tutorial-part1/column-texts.png)
...
![Column Resize Policy](/assets/java/javafx-8-tutorial-part1/column-resize-policy.png)
...
![Person Details Label](/assets/java/javafx-8-tutorial-part1/person-details-label.png)
...
![New RootLayout](/assets/java/javafx-8-tutorial-part1/new-root-layout.png)

2. Open the `RootLayout.fxml` in Scene Builder.

3. Resize the *BorderPane* with *Pref Width* set to 600 and *Pref Height* set to 400.   
![RootLayout Size](/assets/java/javafx-8-tutorial-part1/root-layout-size.png)
...
![New FXML Document](/assets/java/javafx-8-tutorial-part1/javafx-hierarchy.png)   
