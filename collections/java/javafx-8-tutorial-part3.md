...
If something doesn't work, you can compare your `PersonOverviewController` class with [PersonOverviewController.java](/assets/java/javafx-8-tutorial-part3/PersonOverviewController.java).
...
![On Action](/assets/java/javafx-8-tutorial-part3/handle-delete.png)
...
![Create Edit Dialog](/assets/java/javafx-8-tutorial-part3/person-edit-dialog1.png)

2. Use a `GridPane`, `Label`s, `TextField`s and `Button`s to create a Dialog like the following:   
![Edit Dialog](/assets/java/javafx-8-tutorial-part3/person-edit-dialog2.png)   

*If you don't to do the work, you can download this [PersonEditDialog.fxml](/assets/java/javafx-8-tutorial-part3/PersonEditDialog.fxml).* 
