...
![Screenshot AddressApp Part 4](/assets/java/javafx-8-tutorial-part4/addressapp-part4.png)
...
![DarkTheme for RootLayout](/assets/java/javafx-8-tutorial-part4/darktheme-rootlayout.png)
...
![Add Style Class](/assets/java/javafx-8-tutorial-part4/darktheme-personeditdialog.png)
...
![Background Style Select](/assets/java/javafx-8-tutorial-part4/background-style-select.png)   

5. Go to the *Properties* group and select `background` as style class. The background should now turn black.   
![Background Style](/assets/java/javafx-8-tutorial-part4/background-style.png)
...
![Label Header Style](/assets/java/javafx-8-tutorial-part4/label-header-style.png)

2. To each label in the right column (where the actual person details are displayed), add the css Style Class `label-bright`.   
![Label Bright Style](/assets/java/javafx-8-tutorial-part4/label-bright-style.png)
...
![Default Icon](/assets/java/javafx-8-tutorial-part4/default-app-icon.png)

It looks much nicer with a custom icon:

![Custom Icon](/assets/java/javafx-8-tutorial-part4/custom-app-icon.png)
...
![Custom Icon File](/assets/java/javafx-8-tutorial-part4/custom-icon-file.png)
