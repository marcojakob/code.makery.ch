...
- header: "Download Sources"
  ...
  - text: Source of Part 6 (Eclipse Project)
    link: /assets/java/javafx-8-tutorial-part6/addressapp-jfx8-part-6.zip
    icon-css: fa fa-fw fa-download
---

![Screenshot AddressApp Part 6](/assets/java/javafx-8-tutorial-part6/addressapp-part6.png)
...
![Birthday Statistics FXML](/assets/java/javafx-8-tutorial-part6/birthday-statistics-fxml.png)
...
![Category Axis](/assets/java/javafx-8-tutorial-part6/category-axis.png)
...
![Show Statistics Menu](/assets/java/javafx-8-tutorial-part6/show-statistics-menu.png)

Select the *Show Statistics* `MenuItem` and choose `handleShowBirthdayStatistics` for `On Action` (in *Code* group)   

![Show Statistics On Action](/assets/java/javafx-8-tutorial-part6/show-statistics-on-action.png)
