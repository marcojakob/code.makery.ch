...
github: https://github.com/marcojakob/code.makery.ch/edit/master/collections/java/javafx-8-tutorial-ru-part6.md
...
В последней, [7 части Учебника](/java/javafx-8-tutorial-part7/) мы наконец развернем наше приложение (т.е. упакуем и доставим приложение к нашим пользователям).
