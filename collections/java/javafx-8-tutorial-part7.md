...
![Screenshot AddressApp Part 7](/assets/java/javafx-8-tutorial-part7/addressapp-part7.png)
...
![fxbuild settings](/assets/java/javafx-8-tutorial-part7/fxbuild-settings.png)
...
![generate ant build](/assets/java/javafx-8-tutorial-part7/generate-ant-build.png)
...
* [AddressApp.ico](/assets/java/javafx-8-tutorial-part7/AddressApp.ico) for the installer file icon
* [AddressApp-setup-icon.bmp](/assets/java/javafx-8-tutorial-part7/AddressApp-setup-icon.bmp) for the installer splash screen icon
* [AddressApp.icns](/assets/java/javafx-8-tutorial-part7/AddressApp.icns) for the mac installer icon
...
![AddressApp on Windows](/assets/java/javafx-8-tutorial-part7/addressapp-windows.png)
...
![AddressApp on Mac](/assets/java/javafx-8-tutorial-part7/addressapp-macos.png)
...
![Run Ant Build](/assets/java/javafx-8-tutorial-part7/run-ant-build.png)
...
![Deployed File](/assets/java/javafx-8-tutorial-part7/deployed-file.png)
