...
slug: more-html-css/de/icon-fonts
github: false
published: true
prettify: true
comments: false
...
Bilder oder Icons in eine Webseite einzufügen ist nicht schwer. Aber wenn man Texte und Icons kombiniert (z.B. für einen Button) oder wenn die Icons in der Grösse veränderbar sein sollen, dann wird es schwierig.
...
![Kontakt Icon](/assets/library/more-html-css/icon-fonts/contact-icon-de.png)
...
Dieses Beispiel gibt uns eine Flagge: ![Font Awesome Flagge](/assets/library/more-html-css/icon-fonts/fontawesome-flag.png)
