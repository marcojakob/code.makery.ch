...
- header: Artikel in dieser Serie
  ...
  - text: "Hinweise für Lehrpersonen"
    link: /tutorials/greenfoot-kara/de/teachers-info/
...
*Hinweis: Wenn Sie anstatt mit Greenfoot lieber mit einer IDE wie **Eclipse oder NetBeans** arbeiten möchten, lesen Sie die Einführung zu [GameGridKara](/tutorials/gamegrid-kara/de/).*
...
Um gleich loszulegen, gehen Sie zu [Kapitel 1: Erste Schritte](/tutorials/greenfoot-kara/de/chapter1/).

Um mehr Hintergrundinformationen zu erhalten über `GreenfootKara` lesen Sie die [Hinweise für Lehrpersonen](/tutorials/greenfoot-kara/de/teachers-info/).
