...
[[sidebars.items]]
text = "<i class=\"fa fa-fw fa-download\"></i> Parte 1 proyecto Eclipse <em>(requiere al menos JDK 8u20)</em>"
...
En [Tutorial Parte 2](/es/library/javafx-tutorial/part2/) añadiremos algunos datos y funcionalidad a nuestra aplicación de contactos.
