...
<strong>提示</strong>：你能通过改变<code>DATE_PATTERN</code>修改日期的格式。所有可能的格式参考 <a class="alert-link" href="http://docs.oracle.com/javase/8/docs/api/java/time/format/DateTimeFormatter.html">DateTimeFormatter</a>.
</div>
...
如果有些事情不能工作，你可以对比下[PersonOverviewController.java](PersonOverviewController.java)中的`PersonOverviewController`类
...
*如果你不能完成工作，你能下载这个[PersonEditDialog.fxml](PersonEditDialog.fxml).* 
...
在教程[第4部分](/zh-cn/library/javafx-tutorial/part4/)中将添加一些CSS样式表。
