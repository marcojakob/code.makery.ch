...
prettify = true
# comments = true 
commentsIdentifier = "/library/javafx-8-tutorial/fr/part7/"
aliases = [ 
  "/library/javafx-8-tutorial/fr/part7/"
]
weight = 7
...
[[sidebars.items]]
text = "<i class=\"fa fa-fw fa-download\"></i> Projet Eclipse relatif à la partie 7 <em>(JDK 8u40 requis au minimum)</em>"
link = "https://github.com/marcojakob/tutorial-javafx-8/releases/download/v1.1/addressapp-jfx8u40-part-7.zip"
+++

![Capture AddressApp Partie 7](addressapp-part7.png)
...
![réglages fxbuild](fxbuild-settings.png)
...
* [AddressApp.ico](AddressApp.ico) pour l'icône du fichier d'install
* [AddressApp-setup-icon.bmp](AddressApp-setup-icon.bmp) pour le splash screen de l'install
* [AddressApp.icns](AddressApp.icns) pour l'icône de l'install sous mac
* [AddressApp-volume.icns](AddressApp-volume.icns) pour l'icône de desktop sous mac
